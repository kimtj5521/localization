...
void subscribeCallback_imu(const sensor_msgs::Imu::ConstPtr& msg)
{
    ...
    m_imu_data.orientation_w = msg->orientation.w;
    m_imu_data.orientation_x = msg->orientation.x;
    m_imu_data.orientation_y = msg->orientation.y;
    m_imu_data.orientation_z = msg->orientation.z;
    ...
    tmp.w = msg->orientation.w;
    tmp.x = msg->orientation.x;
    tmp.y = msg->orientation.y;
    tmp.z = msg->orientation.z;
...
//void subscribeCallback_odom(const navi::test& msg)
//{
//    m_odom_data_prev = m_odom_data;
